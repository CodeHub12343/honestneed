...
import SponsorshipPaymentForm from '@/components/common/SponsorshipPaymentForm';
import { Check, Star, Clock, Zap, Crown, X } from 'lucide-react';
        ...
        {selectedTier && (
          ...
          >
            ...
            >
              ...
              <SponsorshipPaymentForm tier={selectedTier} onClose={closeModal} />
            </ModalContent>
          </ModalOverlay>
        )}
      </AnimatePresence>
